...
const String ssid = "roboticswifi";                                 //The name of the Wi-Fi network you are connecting to
const String pass = "scil3ehawk";                             //Your WiFi network password
...
int sleeptime = 1800;                                       //length of the sleeptime, in seconds
...
void step4() {
  ...
  thingspeak_send();
  ESP.deepSleep(sleeptime*1000000);                                       //put the ESP to sleep. Sleep value for the function is MICROSECONDS
  digitalWrite(2, LOW);
}
