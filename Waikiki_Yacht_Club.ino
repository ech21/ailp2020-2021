...
const String ssid = "HYC Members WiFi";                                 //The name of the Wi-Fi network you are connecting to
const String pass = "Ultimate4Rainbow$";                             //Your WiFi network password
const long myChannelNumber = 1353914;                            //Your Thingspeak channel number
const char * myWriteAPIKey = "DMHKQXOLP25IBW92";                 //Your ThingSpeak Write API Key
//------------------------------------------------------------------
...
const int EN_RTD = 15;
const int EN_AUX = 13;
const int gate = 2; //This is the pin used for the gate of the transistor
...
const unsigned long thingspeak_delay = 5000;             //how long we wait to send values to thinkspeak, in milliseconds
...
Sequencer1 Wifi_Seq(&reconnect_wifi, 20000 ); //calls the wifi reconnect function every 10 seconds
